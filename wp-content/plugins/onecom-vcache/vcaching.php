...
class VCachingOC {
    ...
    public function varnish_glance()
    {
        ...
        $intro = '';
        if ($this->varnishIp == null) {
            $intro .= sprintf(__('Please setup Varnish IPs to be able to use <a href="%1$s">Performance Cache</a>.', $this->plugin), 'http://wordpress.org/plugins/varnish-caching/');
        } else {
