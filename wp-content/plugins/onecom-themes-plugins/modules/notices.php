...
if( ! function_exists( 'onecom_discouraged_plugins_notice' ) ){
	function onecom_discouraged_plugins_notice(){
		...
		//echo "<pre>";
		//print_r($disc_plugins);
		//print_r($active_plugins_slug);
		//print_r(array_intersect( $disc_plugins, $active_plugins_slug));
		//echo "</pre>";
		...
		//$count = count($active_disc_plugins);

		//$message = sprintf( __('Discouraged plugins should be deactivated to ensure the good performance.', 'onecom-wp') );
...
//onecom_discouraged_plugins_notice();
