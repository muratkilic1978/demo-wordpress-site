...
class Administrator extends InjectionAware {
	...
	private function defineHooks() {
		...
		$loader->addAction( "wp_ajax_wpstg_get_staging", $this, "ajaxGetStaging" );
		...
		$loader->addAction( "wp_ajax_wpstg_deploy", $this, "ajaxDeployLive" );
		...
		$loader->addAction( "wp_ajax_wpstg_clone_log_error", $this, "logError" );
